  ...
  const BRANDS_DATA = [
    {
      ...
      description:
        "SCHUCO is a global leader in window systems, founded in 1951 and headquartered in Bielefeld, Germany, with a presence in over 80 countries worldwide. Lumani is the first and premier partner of SCHUCO in India, bringing German engineering excellence to the Indian market. With over 13 years of industry expertise, Lumani SCHUCO products combine precision engineering with modern aesthetics, offering advanced thermal insulation, noise reduction, and enhanced security features. SCHUCO manufactures premium raw materials while Lumani delivers these high-end solutions to homeowners and builders. Every product is backed by a 10-year warranty on all hardware and accessories, making Lumani SCHUCO a trusted choice for contemporary homes and commercial spaces.",
