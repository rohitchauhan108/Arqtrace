      ...
      <div className="container mx-auto px-6 lg:px-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <motion.h2
              variants={itemVariants}
              className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-[#2d1e18] leading-[1.1] mb-8"
            >
            ...
            <motion.p
              variants={itemVariants}
              className="text-stone-500 text-base md:text-lg leading-relaxed mb-12 max-w-xl font-sans"
            >
              Arqtrace combines premium product quality, professional guidance,
              and dependable installation to create enduring solutions for homes
              and projects.
            </motion.p>
            ...
            >
              <div className="group">
                <div className="flex items-center gap-5 mb-3">
                  ...
                  <h3 className="text-xl font-serif font-bold text-[#2d1e18]">
                    Best-in-Class
                  </h3>
                </div>
            ...
            <motion.div variants={itemVariants} className="space-y-5 mb-12">
              {[
                ...
                <div
                  key={idx}
                  className="flex items-center gap-4 p-4 rounded-xl bg-stone-50/50 border border-transparent hover:border-stone-100 hover:bg-white hover:shadow-sm transition-all duration-300"
                >
                  <CheckCircle2 className="w-5 h-5 text-[#bd845c] shrink-0" />
                  <span className="text-sm md:text-base text-stone-700 font-medium">
                    {text}
                  </span>
                </div>
              ))}
              ...
              >
                ...
                >
                  ...
                  <div className="flex flex-col">
                    <span className="text-[11px] font-bold uppercase tracking-[0.3em] leading-tight text-[#bd845c] mb-1">
                      Years of
                    </span>
                    <span className="text-sm font-serif font-medium tracking-wide text-stone-300">
                      Experience
                    </span>
                  </div>
                </motion.div>
