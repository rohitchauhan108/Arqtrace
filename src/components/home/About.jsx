...
const About = () => {
  return (
    <section
      id="about"
      className="relative py-20 lg:py-24 bg-white select-none"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col justify-center">
            ...
            <p className="text-[#bd845c] font-semibold text-sm mb-4 font-sans tracking-wide">
              Premium aluminum and uPVC solutions for homes, projects, and
              outdoor spaces.
            </p>

            <p className="text-stone-500 text-sm md:text-base leading-relaxed mb-8 max-w-xl">
              Arqtrace is an all-in-one solution for premium aluminum and UPVC
              windows, doors, partitions, and outdoor furniture. We strive to
              bring you nothing but the best quality of products for your
              everlasting home or your upcoming project.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="text-[#2d1e18] font-serif font-bold text-sm mb-0.5">
                    Aluminum & uPVC
                  </h4>
                  <p className="text-stone-400 text-xs">
                    Modern windows, doors, and partitions
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-stone-400 text-xs">
                    Stylish and durable for every exterior
                  </p>
                </div>
              </div>
            </div>
